    ...
    <div className="flex flex-col h-full overflow-y-auto p-6">
      <div className="w-full bg-card rounded-2xl border border-border shadow-sm overflow-hidden">
        ...
        <div className="bg-gradient-to-br from-primary/20 via-secondary/10 to-transparent p-8 md:p-12 text-center border-b border-border">
          <div className="mx-auto h-16 w-16 bg-primary/10 border border-primary/20 rounded-2xl shadow-sm flex items-center justify-center mb-6">
        ...
        <div className="p-6 md:p-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-primary/5 border border-primary/20 rounded-2xl p-6 flex flex-col items-center text-center hover:border-primary/40 transition-colors">
              <div className="h-12 w-12 bg-primary/15 rounded-xl border border-primary/20 flex items-center justify-center mb-4 shadow-sm">
            ...
            <div className="bg-muted/20 border border-border rounded-2xl p-6 flex flex-col items-center text-center opacity-60">
              <div className="h-12 w-12 bg-secondary/20 rounded-xl border border-secondary/20 flex items-center justify-center mb-4">
