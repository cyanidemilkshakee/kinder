...
import { Mail, HelpCircle, Bug, FileText, ChevronRight } from "lucide-react"
        ...
        <div className="space-y-6">
          ...
          <section className="space-y-6">
            ...
            <div className="grid gap-4">
              <div>
                <h3 className="font-semibold text-base">Verified &amp; Safe</h3>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1 leading-relaxed">
                  Your profile is completely hidden from the public internet. Only authenticated students can view profiles in the discovery pool.
                </p>
              </div>

              <div>
                <h3 className="font-semibold text-base">Meaningful Interactions</h3>
                <p className="text-sm text-muted-foreground mt-1 leading-relaxed">
